...
COLOR_RANGES = {
    ...
    "Teal":   {"space": "LAB", "lower": np.array([10, 110, 75]),   "upper": np.array([90, 135, 110])},
...
def detect_shape(contour):
    ...
    elif( 6 <= vertices <= 7) and is_convex and 0.70 <= circularity <= 0.82:
        return "Segment", None
    ...
    try:
        while True:
            ...
            if global_largest_area > 3000 and global_largest_contour is not None:
                ...
                # Draw it
                cv.drawContours(BGR_frame, [global_largest_contour], -1, (0, 255, 0), 2)
                ...
                cv.putText(BGR_frame, label, (60, 50), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 1)
